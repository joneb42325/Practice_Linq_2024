...
namespace Practice_Linq_2024
{
    internal class Program
    {
        ...
        static void Query2(List<FootballGame> games)
        {
            ...
            var selectedGames = games // Корегуємо запит !!!
            .Where(game => game.Tournament == "Friendly" &&
        ...
        static void Query3(List<FootballGame> games)
        {
            ...
            var selectedGames = games   // Корегуємо запит !!!
                .Where(game => game.Country == "France" &&
                                game.Date.Year == 2021 &&
        ...
        static void Query4(List<FootballGame> games)
        {
            ...
            var selectedGames = games   // Корегуємо запит !!!
            .Where(game => game.Away_team == "Germany" &&
        ...
        .Select(game => new
         {
            ...
            Result = game.Home_score > game.Away_score ? "Win" :
                     game.Home_score < game.Away_score ? "Loss" : "Draw"
        })
        .ToList();
            // Перевірка
            Console.WriteLine("\n======================== QUERY 9 ========================");
